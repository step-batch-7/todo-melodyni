...
const { TodoList, Todo } = require('./todoClass');
...
const saveNewTodos = function(req, res) {
  ...
  todoList.todos.push(new Todo(id, title, newTasks));
...
const getRequestedTodo = function(id) {
  ...
  return todoList.todos.find(isRequestedTodo);
};
...
const deleteTodo = function(req, res) {
  ...
  const todoToBeDeleted = getRequestedTodo(req.body);
